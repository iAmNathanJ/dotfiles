...
(load "~/code/dotfiles/emacs/theme-and-colors.el")
(load "~/code/dotfiles/emacs/god-mode.el")
(load "~/code/dotfiles/emacs/markdown-preview.el")
(load "~/code/dotfiles/emacs/convenience.el")
